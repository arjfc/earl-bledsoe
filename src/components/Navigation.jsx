...
import { FaBars, FaTimes, FaUser, FaBook, FaEnvelope, FaStar } from 'react-icons/fa';
...
const Navigation = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ['home', 'about', 'book', 'reviews', 'contact'];
  ...
  const navItems = [
    ...
    { name: 'The book', href: '#book', icon: <FaBook size={16} />, id: 'book' },
    { name: 'Reviews', href: '#reviews', icon: <FaStar size={16} />, id: 'reviews' },
  ...
  return (
    ...
    >
      <div className="container-custom mx-auto flex justify-between items-center">
        ...
        >
          <span className="font-author text-lg md:text-xl text-secondary">
            {authorData.fullName}
          </span>
        </a>
